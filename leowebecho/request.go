...
import (
	...
	"github.com/cqlsy/leolib/leovalidation"
...
//var SessionCookieName = "leocmsSession"
...
func (req *Request) ContextGetInt(key string) int {
	...
	return leostrconv.AtoIDefault0(data.(string))
}
...
//			req.jsonParam.val = *leogo.InitJson(defJson).Get("index")
//		}
//	} else {
...
//	} else {
//		if len(req.params.val) == 0 {
//			req.params.val = leostrconv.FormatInt(val)
//		}
//	}
//	return req
//}
...
// 获取int类型参数
// 若参数不存在则默认返回0
func (req *Request) GetIntWithDefault(v int) int {
	if req.getParamValue() == "" {
		return v
	}
	if value, err := strconv.Atoi(req.getParamValue()); err != nil {
...
//	req.params.val = leoxss.XssBlackLabelFilter(req.params.val)
//	return req
//}
