...
//		name = name + ".html"
//	}
//	if leogo.Config.GetString("app.RunMode") == "dev" {
//		err := leotemplate.BuildTemplate("view")
//		if err != nil {
//			panic(err)
//		}
//	}
//	err := leotemplate.ExecuteTemplate(&buf, name, resp.context.Get("ResponseData"))
//	if err != nil {
...
//		sessionValue, _ := aes.AesEncrypt(SessionPsk, sessionData)
